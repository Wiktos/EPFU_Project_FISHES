...
void PRINT(char * msg, enum COLOR color){
    ...
    SetConsoleTextAttribute(hConsole, saved_attributes);
      ...
      switch(color){
        default: { break;}
        case DEFAULT : {break;}
        case RED : {printf("0x1B[%dm %s", 31, msg); break;}
        case GREEN : {printf("0x1B[%dm %s", 32, msg); break;}
        case BLUE : {printf("0x1B[%dm %s", 34, msg); break;}
        case YELLOW : {printf("0x1B[%dm %s", 33, msg); break;}
    }
    #endif
}
